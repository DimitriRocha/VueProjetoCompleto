	...
	<div class="">
		<div class="row">
			<div class="col-12 mt-2" v-for="(form, key) in formData" v-bind:style="form.style">
				<small><label :for="form.idName">{{ form.label }}</label></small>

				<!-- Caso seja um input padrão -->
				<div v-if="form.type == 'text' || form.type == 'password' || form.type == 'number' || form.type == 'email' || form.type == 'date' || form.type == 'month'">
				...
				<!-- Caso seja um select -->
				<div v-else-if="form.type == 'select'">
